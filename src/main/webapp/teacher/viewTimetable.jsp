...
<head>
    ...
    <title>View Timetable - Teacher</title>
    ...
    width: calc(100% - 250px); /* Prevent overlap */
                    ...
                    <tbody>
                        <%
                            try {
                                ...
                                String query = "SELECT t.id, c.course_name, t.day_of_week, t.start_time, t.end_time, t.meeting_link, " +
                                               "(SELECT COUNT(*) FROM enroll_courses e WHERE e.course_id = t.course_id) AS student_count " +
                                               "FROM timetable t " +
                        ...
                        %>
                        <tr>
                            <td colspan="6" class="text-danger">No timetable available.</td>
                        </tr>
                        <%
                                }
                            } catch (Exception e) {
