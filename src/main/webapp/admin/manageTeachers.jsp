...
<title>Manage Teachers - ABC Coaching</title>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><%= rs.getString("tmail") %></td>
                    <td><%= rs.getString("taddr") %></td>
                    <td><%= rs.getString("tuser") %></td>
                    <td>
                        <a href="editTeacher.jsp?tid=<%= rs.getInt("tid") %>" class="edit-btn">Edit</a>
                    </td>
                    <td>
                        <a href="deleteTeacher.jsp?tid=<%= rs.getInt("tid") %>" class="delete-btn" 
